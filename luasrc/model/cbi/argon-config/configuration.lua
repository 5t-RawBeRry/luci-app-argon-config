...
-- [[ 模糊设置 ]]--
br = SimpleForm('config', translate('Display'), translate('Here you can set the blur and transparency of the login page of argon theme, and manage the background pictures and videos.[Chrome is recommended]'))
br.reset = false
br.submit = false
